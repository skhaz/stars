...
- [pigmentolabs/carimbo](https://github.com/pigmentolabs/carimbo) - 2D game engine, developed in modern C++ and built upon SDL, OpenAL, Chipmunk, with scripting capabilities using Lua, and designed to be portable to the web through WebAssembly.
